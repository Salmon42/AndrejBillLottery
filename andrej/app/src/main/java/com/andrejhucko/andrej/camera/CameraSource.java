package com.andrejhucko.andrej.camera;
...
import com.andrejhucko.andrej.backend.ocr.VisionImageProcessor;
...
public class CameraSource {
    ...
    private final int requestedPreviewWidth = 1280; // 480;
    private final int requestedPreviewHeight = 960; // 360;
    private final boolean requestedAutoFocus = true;

    private String flashMode = null; // Cookie mod
        ...
        synchronized (processorLock) {
            if (camera != null && mode != null) {
                ...
                if (parameters.getSupportedFlashModes() == null) {
                    Log.wtf(TAG, "setFlashMode failed [1]");
                    return;
                }
            ...
            Log.wtf(TAG, "setFlashMode failed [2]");
        }
    }
    ...
    private Camera createCamera() throws IOException {
        ...
        // CookieMod: add flash mode modification
        if (flashMode != null) {
            if (parameters.getSupportedFlashModes() != null &&
                    parameters.getSupportedFlashModes().contains(flashMode)) {
                parameters.setFlashMode(flashMode);
            }
            else {
                Log.wtf(TAG, "Camera flash mode: " + flashMode + " is not supported on this device.");
            }
        }
